...
/**
 * Bufo - Binary buffer utility for reading/writing binary data
 */
class Bufo {
	constructor(data) {
	...
	slice(start, end) {
		return new Bufo(this.buffer.slice(start, end));
	}
}
...
// Export to ES6 modules - set as default and named export.
